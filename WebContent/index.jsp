					...
					<div class="col-md-8 mx-auto my-5">
						...
						<form action="">
							<div class="input-group m-3" style="min-width: 200px">
								...
								</span> <select id="index-search-area" class="form-select me-2"
							...
							<div class="input-group m-3" style="min-width: 200px">
								<span class="input-group-text"
									style="width: 50px; background-color: #001e3d"> <i
									class="bi bi-geo-alt-fill m-auto" style="color: white"></i>
								</span> <select id="index-search-content-id" class="form-select me-2"
									style="background-color: #e6e6e6">
							...
							<div class="input-group m-3" style="min-width: 200px">
								<span class="input-group-text"
									style="width: 50px; background-color: #001e3d"> <i
									class="bi bi-geo-alt-fill m-auto" style="color: white"></i>
								</span> <input id="index-search-keyword" class="form-control me-2"
