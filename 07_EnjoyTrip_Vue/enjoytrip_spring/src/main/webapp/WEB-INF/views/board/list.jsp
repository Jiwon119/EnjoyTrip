...
<%@ include file="/include/head.jsp" %>
      ...
      <div class="row justify-content-center">
        <div class="col-lg-8 col-md-10 col-sm-12">
          <h2 class="my-3 py-3 shadow-sm bg-light text-center">
            <mark class="sky">핫플레이스 공유 + 자유게시판</mark>
          </h2>
        </div>
        <div class="col-lg-8 col-md-10 col-sm-12">
          <div class="row align-self-center mb-2">
            <div class="col-md-2 text-start">
              <button type="button" id="btn-mv-register" class="btn btn-primary btn-sm">
                	글쓰기
              </button>
              <button type="button" id="board-sort" class="btn btn-secondary btn-sm">
                	인기글
              </button>
            </div>
    ...
    <script>
      ...
      document.querySelector("#board-sort").addEventListener("click", function () {
          location.href = "${root}/article?action=list&type=sort";
        });
