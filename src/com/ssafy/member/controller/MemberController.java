...
public class MemberController extends HttpServlet {
	...
	protected void doRegist(HttpServletRequest request, HttpServletResponse response)
		...
		member.setUserBirth(request.getParameter("birthday"));
		member.setUserPhone(request.getParameter("phone_number"));
...
//		response.getWriter().write(jsonResponse);
	...
	protected void doUpdate(HttpServletRequest request, HttpServletResponse response)
		...
		member.setUserBirth(request.getParameter("info_birthday"));
		member.setUserPhone(request.getParameter("info_phone_number"));
		request.getSession().setAttribute("user", member);
